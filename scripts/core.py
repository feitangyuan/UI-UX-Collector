...
CSV_CONFIG = {
    ...
    "collected": {
        "file": "collected-designs.csv",
        "search_cols": ["Style Category", "Type", "Keywords", "Effects & Animation", "Best For", "Notes"],
        "output_cols": ["ID", "Date", "Style Category", "Type", "Source", "Keywords", "Primary Colors", "Secondary Colors", "Effects & Animation", "Best For", "Do Not Use For", "Light Mode", "Dark Mode", "Performance", "Accessibility", "Mobile-Friendly", "Framework Compatibility", "Complexity", "Notes"]
    }
}
...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "collected": ["collected", "saved", "my designs", "bookmarked", "reference", "inspiration"]
    }
